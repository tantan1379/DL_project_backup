...
from models.utils.layers import unetConv2,unetUp,unetConv2_dilation,unetUp_add,unetUp_cat
...
class UNet(nn.Module):
    ...
    def forward(self, inputs):
        ...
        up4 = self.up_concat4(center,conv4)  # 256*64*32
...
class UNet_add(nn.Module):
    ...
    def forward(self, inputs):
        ...
        up4 = self.up_add4(center,conv4)  # 256*64*32
...
if __name__ == '__main__':
    ...
    model = UNet(in_channels=3,n_classes=1,feature_scale=2).cuda()
    img = torch.Tensor(1,3,512,256).cuda()
    out = model(img)
