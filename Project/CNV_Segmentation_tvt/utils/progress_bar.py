...
class Train_ProgressBar(object):
    ...
    def __init__(self, mode='train', epoch=None, total_epoch=None, current_loss=None, current_lr=0, save_model_path=None, total=None, current=None, width=70, symbol=">", output=sys.stderr):
        assert len(symbol) == 1
    ...
    def __call__(self):
        ...
        self.train_write_message = "Epoch: %(epoch)d/%(epochs)d [ Current: Loss %(current_loss)f lr: %(current_lr)f ]" % args
